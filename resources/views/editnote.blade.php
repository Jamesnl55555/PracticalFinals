...
<body> 
    ...
    <div class="container mx-auto flex flex-col lg:flex-row justify-between items-center">
        ...
        <div class="lg:flex flex-col lg:flex-row lg:space-x-4 lg:mt-0 mt-4 flex flex-col items-center text-xl">
            <p class="text-white  px-4 py-2  hover:text-orange-600">
        ...
        <div class="mt-3 text-center text-4xl font-bold">Edit note</div>
    ...
    <form action="{{ route('nupdate', ['id' => $note->id]) }}" method="POST">
        ...
        <div class="p-8">
            ...
            <input type="text" name="title" class="mt-1 block w-1/2 rounded-md border border-slate-300 bg-white px-3 py-4 placeholder-slate-400 shadow-sm placeholder:font-semibold placeholder:text-gray-500 focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500 sm:text-sm" value="{{ $note->title }}"/>
            </div>
            <div class="">
            <input type="text" id="text" cols="30" rows="10" class="mb-10 h-40 w-full resize-none rounded-md border border-slate-300 p-5 font-semibold text-gray-300" name="body" value="{{ $note->body }}"/>
            </div>
            <div class="text-center">
            <button type="submit" class="cursor-pointer rounded-lg bg-blue-700 px-8 py-5 text-sm font-semibold text-white">Edit Note</button>
