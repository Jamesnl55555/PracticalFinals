...
<body>
  ...
  <div class="mt-3 text-center text-4xl font-bold">Create a note</div>
  <div class="p-8">
    <div class="flex gap-4">
      <input type="text" name="title" placeholder="Enter Note Title" class="mt-1 block w-1/2 rounded-md border border-slate-300 bg-white px-3 py-4 placeholder-slate-400 shadow-sm placeholder:font-semibold placeholder:text-gray-500 focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500 sm:text-sm"/>
    </div>
    <div class="">
      <input type="text" id="text" cols="30" rows="10" class="mb-10 h-40 w-full resize-none rounded-md border border-slate-300 p-5 font-semibold text-gray-300" name="body" placeholder="Enter Note Content"></textarea>
    </div>
    <div class="text-center">
      <button type="submit" class="cursor-pointer rounded-lg bg-blue-700 px-8 py-5 text-sm font-semibold text-white">Create Note</button>
    </div>
    </div>
    </div>
    </form>
